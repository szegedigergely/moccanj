jQuery(document).ready(function($) {
	...
	if (Modernizr.csstransforms3d && cineBg.length) {
		var threeDee = document.getElementById('threedee_wrapper');

		$(document).on("mousemove", function(event) {
			threeDee.style.webkitTransform = threeDee.style.MozTransform = threeDee.style.msTransform = threeDee.style.OTransform = threeDee.style.transform = "rotateX("+(4*event.clientY/wH-2)+"deg) rotateY("+(-6*event.clientX/wW+3)+"deg) translateZ(0)";
		})
	}
	/* ==========================================================================
	   HEADER COLLAPSER
